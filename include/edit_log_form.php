<form method="post">
				<input type="hidden" name="log_id" value="<?php echo $_GET['edit_log'];?>">
				<td>
				<select style="width: 120px !important;" id="project_select"
					name="project_id">
						<?php 
				...
				<td>
				<input type="hidden" id="selected_category_id" value="<?php echo $log->get_category_assoc_id();?>">
				<select style="width: 120px !important;" id="category_select"
					name="category_assoc_id">
				</select>
				</td>
				<td>
				<input type="hidden" id="selected_date" value="<?php echo $log->get_date();?>">
				<select style="width: 120px;" id="date_select" name="date">
				</select>
				</td>
