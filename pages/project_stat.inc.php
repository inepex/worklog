<div class="worklog-container">
 ...
 <div class="subheader">
	...
	<h4 style="float: left;">Inetrack új weboldal</h4>
	...
	<tr>
	<th>SUM </th><td><div style="height: 20px; width: 600px; border:1px  solid #d0d0d0;"><div style="height: 20px;  width:400px; background: #0054a6;"></div></div></td><td>2:00 / 3:00 (75%)</td>
	</tr>
	
	
	</table>
	
	<h4 style="float: left;">Másik project</h4>
